        ...
        <ul className="font-bold text-lg flex flex-col md:flex-row items-center">
          ...
          <li className={list}>
            <Link to="/cart" className="link">Cart
              <span className="ml-1 p-1 rounded-xl text-red-600">{cartItems.length}</span>
            </Link>
          </li>
          <button 
            className="px-4 py-2 bg-pink-600 text-white rounded-md mt-2 md:mt-0 md:ml-4 transition duration-300 hover:bg-blue-700"
            onClick={() => {
